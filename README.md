...
这是 `myavalonia.plugin.fractal.art` 的 Managed Plugin 解决方案。当前已完成 G0001–G0005.1：
...
L-System 支持 5 个经典示例、公理/产生式自定义、受预算展开和 Turtle 路径解释。作品格式现为 v5，并显式迁移 v1–v4。
...
首版保持零 Tool、零 Workbench Command、零默认快捷键。G0001–G0005.1 的计划、实施方案、结果与门禁证据见
