...
public sealed class FractalArtPluginModule : IPluginModule
{
    public void Configure(IPluginRegistration registration)
    {
        ...
        registration.AddWorkflowAction<ExportArtworkBatchWorkflowActionHandler>(
            ExportArtworkBatchWorkflowAction.CreateDescriptor());
        ...
        // G0001 明确采用零 Tool、零 Workbench Command、零默认快捷键策略；G0012 的三个
